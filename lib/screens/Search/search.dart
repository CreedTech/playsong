...
// import '../../custom_widgets/search_bar.dart' as searchbar;
...
// import '../../custom_widgets/media_tile.dart';
...
//         });
//       default:
//         Logger.root.info('calling playson search');
//         searchedList = await PlaySongAPI()
//             .fetchSearchResults(query == '' ? widget.query : query);
...
//     topSearch.value = await PlaySongAPI().getTopSearches();
//   }
